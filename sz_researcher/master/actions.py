...
from sz_researcher.master.prompts import *
from sz_researcher.scraper.scraper import Scraper
from sz_researcher.utils.llm import *
...
def get_retriever(retriever):
    ...
    match retriever:
        case "google":
            from sz_researcher.retrievers import GoogleSearch
            retriever = GoogleSearch
        # case "searx":
        #     from sz_researcher.retrievers import SearxSearch
        #     retriever = SearxSearch
        # case "serpapi":
        #     from sz_researcher.retrievers import SerpApiSearch
        #     retriever = SerpApiSearch
        # case "googleSerp":
        #     from sz_researcher.retrievers import SerperSearch
        #     retriever = SerperSearch
        case "duckduckgo":
            from sz_researcher.retrievers import Duckduckgo
            retriever = Duckduckgo
        case "bing":
            from sz_researcher.retrievers import BingSearch
            retriever = BingSearch
        # case "tavily":
        #     from sz_researcher.retrievers import TavilySearch
        #     retriever = TavilySearch
        case "custom":
            from sz_researcher.retrievers import CustomRetriever
...
async def handle_json_error(response):
    ...
    return "Default Agent", "你是一名善于批判性思考的AI研究助理。你唯一的任务是针对给定的文本撰写文笔流畅、广受好评、客观且结构清晰的报告。"
